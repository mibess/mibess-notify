...
const icons: Record<string, string> = {
  ...
  contacts:
    "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2 M13 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0 M18 8a3 3 0 0 1 0 6 M22 21v-2a4 4 0 0 0-3-3.8",
  groups:
    "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2 M13 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0 M18 5h4 M20 3v4",
  channels:
  ...
  webhooks:
    "M6 12a4 4 0 1 0 4 4 M18 12a4 4 0 1 1-4 4 M9 8a4 4 0 1 1 6 0 M10 7 6 16 M14 7l4 9 M6 16h12",
  ...
  refresh: "M20 7a8 8 0 1 0 1 8 M20 2v6h-6",
  logout: "M9 5H4v14h5 M10 12h11 M17 8l4 4-4 4",
  menu: "M4 6h16 M4 12h16 M4 18h16",
  key: "M15 7a5 5 0 1 0 0 .1 M12 11l9 9 M17 16l3-3",
  clock: "M12 8v4l3 2 M22 12a10 10 0 1 1-20 0 10 10 0 0 1 20 0",
  alert: "M12 3 2 21h20z M12 9v5 M12 17v.5",
...
export class IconComponent {
  ...
  path() {
    return icons[this.name()] || icons["events"];
  }
}
